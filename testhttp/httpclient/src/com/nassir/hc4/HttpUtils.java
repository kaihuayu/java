...
public class HttpUtils {
     ...
     * @throws IOException
     */
    public static String post(String url, Map<String, String> params, int timeout, Object... objects) throws IOException {
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException{
    	...
    	int retStatu = HttpUtils.getPostRetStatu("http://localhost:8088/marketing/backStageLogin.jsp", 10);
    	int numOut = 5;
    	int i = 0;
    	if(retStatu!=200){
    		if(++i==numOut){
...
//    		e.printStackTrace();
     ...
     * @throws IOException
     */
    public static File get(String url, Map<String, String> params,String fileName) throws IOException {
        HttpClient httpclient = new DefaultHttpClient();
        httpclient.getParams().setIntParameter("http.socket.timeout", 100000);
     ...
     */
    public static String postFile(String url, Map<String, String> params, int timeout, File file) throws IOException{
        HttpClient httpclient = new DefaultHttpClient();
        httpclient.getParams().setIntParameter("http.socket.timeout", timeout * 1000);
        httpclient.getParams().setBooleanParameter("http.protocol.expect-continue", false);
        String retVal = "";
